...
public class Controller implements Initializable {
     ...
     * image folder path
     */
    public static final String IMAGE_FOLDER_PATH = "C:\\Users\\stoic\\Desktop\\master\\An2\\Sem1\\Advances in Computer Vision\\ACVProjects\\hamburg_taxi";

    @FXML
    private Button btnLoadFirstFrame;

    @FXML
    private ImageView iwFirstImage;

    @FXML
    private ImageView iwSecondImage;
    ...
    protected void onBtnLoadFirstFrameClick() throws IOException {
        ...
        if (selectedFile != null) {
            ...
            this.imageProcessor.setFirstImage(selectedFile);
            this.iwFirstImage.setImage(image);
        }
    ...
    protected void onBtnLoadSecondFrameClick() throws IOException {
        ...
        if (selectedFile != null) {
            Image image = new Image(selectedFile.toURI().toString());
            this.imageProcessor.setSecondImage(selectedFile);
            this.iwSecondImage.setImage(image);
        }
    ...
    protected void computeMotion() {
        ...
        List<int[]> coordinatesList = this.imageProcessor.computeMotion(blockSize, zoneSize);
        drawMotionLines(coordinatesList);
